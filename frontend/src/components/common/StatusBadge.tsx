...
const MAP: Record<string, { label: string; cls: string }> = {
  ...
  accepted:         { label: 'Đang đón',          cls: 'bg-primary-tint text-primary' },
  picking_up:       { label: 'Đang đón',          cls: 'bg-primary-tint text-primary' },
  in_progress:      { label: 'Đang di chuyển',   cls: 'bg-primary text-white' },
