...
return [
    ...
    */
    ...
    /*
     * Van an toàn khi test trên production: đặt số điện thoại vào đây thì MỌI
     * notification gửi tới số khác bị huỷ (xem RestrictNotificationsToTestPhone).
     * ⚠️ Để trống khi không test — quên xoá là cả hệ thống ngừng gửi thông báo.
     */
    'notify_only_phone' => env('NOTIFY_ONLY_PHONE'),
